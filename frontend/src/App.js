...
function App() {
  const stripePromise = loadStripe("pk_test_51OxZ4tRpyQbXRNCjJmXfrdEpAbrZfdslIZye7y1yEGSvNBXITGfyQwA1qy2HBjw66qsHZhsOEAiuEiNISbnzWvpH00KlvX9FjO");
  ...
  //defines a Route component that matches all paths "/" and renders the Main com
...
/>
  ...
  return (
    <div className="App">
    {/* This ensures that the rounting functionallity is available throughout the a*/}
